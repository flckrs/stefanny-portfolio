<template>
  <div class="case-study-background" id="case-study">
    ...
    <section class="case-study-1">
      ...
      <div class="case-study-1-wrapper">
        <div class="case-study-text-wrapper">
          <div class="case-study-content-wrapper">
            ...
            <h1 class="case-study-header">Streaming Service App - OTT App Features Development</h1>
          </div>
          ...
          <div class="case-study-content-wrapper">
              ...
              <p class="case-study-text">April 2022 - October 2022</p>
          </div>
        </div>
      ...
      <img src="../assets/images/casestudy2/curvy2.svg" alt="background image" class="curvy-bg">

      <img src="../assets/images/casestudy2/backgroundOTT.svg" alt="background image" class="background-hero-bg">

      <img src="../assets/images/casestudy2/image2.svg" alt="mockup image" class="mockup-hero-bg">
    ...
    <section class="case-study-2">
      <div class="case-study-2-wrapper">
          ...
          <div class="case-study-2-1-wrapper">
            <div class="case-study-2-1 what-i-did">
              ...
              <div class="what-i-did-pills-wrapper">
                ...
                <div class="item-pills-wrapper black">MOBILE APP DESIGN</div>
                <div class="item-pills-wrapper black">RESEARCH</div>
                <div class="item-pills-wrapper black">ANALYSIS</div>
                <div class="item-pills-wrapper black">USER FLOW</div>
                <div class="item-pills-wrapper black">DOCUMENTATION</div>
                <div class="item-pills-wrapper black">PRESENTATION</div>
        ...
        <div class="case-study-2-2-wrapper-0">
          <div class="case-study-2-2-wrapper-1">
            <img src="../assets/images/casestudy2/products/image02.svg" alt="product sneakpeek" class="case-study-image">
          </div>
        </div>
        ...
        <div class="case-section-wrapper">
          <div class="case-section-wrapper-container">
            <div class="case-section-header-wrapper">
              ...
              <h3 class="case-section-title">Our Vision</h3>
            </div>

            <p>To have Vision+ as a leading streaming services app and transform it into a super app, we had to enhance the overall user experience of the V+ app. Simultaneously, we must develop new features for Vision+ to make it a comprehensive super app (this part can be unlocked by password). It's crucial to ensure that every feature is easily accessible and enjoyable for all users.</p>
          </div>
        </div>
        ...
        <div class="case-study-2-2-wrapper-0">
          <div class="case-study-2-2-wrapper-1">
            <img src="../assets/images/casestudy2/products/image03.svg" alt="product sneakpeek" class="case-study-image">
          </div>
        </div>
        ...
        <div class="case-study-2-2-wrapper-0">
          <div class="case-study-2-2-wrapper-1">
            <img src="../assets/images/casestudy2/products/image04.svg" alt="product sneakpeek" class="case-study-image">
          </div>
        </div>
        ...
        <div class="case-study-2-2-wrapper-0">
          <div class="case-study-2-2-wrapper-1">
            <img src="../assets/images/casestudy2/products/image05.svg" alt="product sneakpeek" class="case-study-image">
          </div>
        </div>
        ...
        <div class="case-study-2-2-wrapper-0">
          <div class="case-study-2-2-wrapper-1 margin-top">
            <img src="../assets/images/casestudy2/products/image06.svg" alt="product sneakpeek" class="case-study-image">
          </div>
        </div>
        ...
        <div class="case-study-2-2-wrapper-0">
          <div class="case-study-2-2-wrapper-1">
            <img src="../assets/images/casestudy2/products/image07.svg" alt="product sneakpeek" class="case-study-image">
          </div>
        </div>
